...
class Interceptor extends \OlegKoval\RegenerateUrlRewrites\Console\Command\RegenerateUrlRewrites implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCommandOptions');
        return $pluginInfo ? $this->___callPlugins('getCommandOptions', func_get_args(), $pluginInfo) : parent::getCommandOptions();
    }
