...
class Interceptor extends \StripeIntegration\Payments\Model\ResourceModel\StripeCustomer\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getByCustomerId');
        return $pluginInfo ? $this->___callPlugins('getByCustomerId', func_get_args(), $pluginInfo) : parent::getByCustomerId($customerId, $pk);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBySessionId');
        return $pluginInfo ? $this->___callPlugins('getBySessionId', func_get_args(), $pluginInfo) : parent::getBySessionId($sessionId, $pk);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getByStripeCustomerId');
        return $pluginInfo ? $this->___callPlugins('getByStripeCustomerId', func_get_args(), $pluginInfo) : parent::getByStripeCustomerId($stripeCustomerId);
    }
