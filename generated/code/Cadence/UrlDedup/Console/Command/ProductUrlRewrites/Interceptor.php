<?php
namespace Cadence\UrlDedup\Console\Command\ProductUrlRewrites;

/**
 * Interceptor class for @see \Cadence\UrlDedup\Console\Command\ProductUrlRewrites
 */
class Interceptor extends \Cadence\UrlDedup\Console\Command\ProductUrlRewrites implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllStoreIds');
        return $pluginInfo ? $this->___callPlugins('getAllStoreIds', func_get_args(), $pluginInfo) : parent::getAllStoreIds();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUrlAttributes');
        return $pluginInfo ? $this->___callPlugins('getUrlAttributes', func_get_args(), $pluginInfo) : parent::getUrlAttributes($attributes);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUrlAttributeUpdates');
        return $pluginInfo ? $this->___callPlugins('getUrlAttributeUpdates', func_get_args(), $pluginInfo) : parent::getUrlAttributeUpdates($attributeId, $storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'dedupUrlAttribute');
        return $pluginInfo ? $this->___callPlugins('dedupUrlAttribute', func_get_args(), $pluginInfo) : parent::dedupUrlAttribute($entityValue, $attributeId, $masterEntityId, $storeId, $additional);
    }

    /**
     * {@inheritdoc}
     */
    public function processUrlAttributeUpdates($attributeId, $storeId, \Symfony\Component\Console\Output\OutputInterface $output)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'processUrlAttributeUpdates');
        return $pluginInfo ? $this->___callPlugins('processUrlAttributeUpdates', func_get_args(), $pluginInfo) : parent::processUrlAttributeUpdates($attributeId, $storeId, $output);
    }

    /**
     * {@inheritdoc}
     */
    public function processCascadingUrlAttributeUpdates($attributeId, $storeId, \Symfony\Component\Console\Output\OutputInterface $output)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'processCascadingUrlAttributeUpdates');
        return $pluginInfo ? $this->___callPlugins('processCascadingUrlAttributeUpdates', func_get_args(), $pluginInfo) : parent::processCascadingUrlAttributeUpdates($attributeId, $storeId, $output);
    }
